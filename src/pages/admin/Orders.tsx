...
//               <button
//                 type="button"
//                 className="h-[40px] px-4 bg-blue-700 hover:bg-blue-800 text-white rounded-lg text-sm font-medium transition-colors"
//               >
...
//                 type="button"
//                 className="h-[40px] w-[100px] bg-blue-700 hover:bg-blue-800 text-white rounded-lg text-sm font-medium transition-colors"
//               >
//                 ยืนยัน
//               </button>
//               <button
//                 type="button"
//                 className="h-[40px] w-[100px] rounded-lg border border-black text-gray-700 text-sm font-semibold font-['Anuphan']"
//               >
//                 ยกเลิก
//               </button>
//             </div>
