...
// แก้ไขให้ตรงกับ Redux state ของคุณที่ใช้คำว่า 'stockQuantity' ในการเก็บจำนวนชิ้นในตะกร้า
...
function CartPage() {
  ...
  const subtotal = cartItems.reduce(
    (sum: number, item: CartItemType) => sum + (item.price * item.stockQuantity),
    0
  );
            ...
            {cartItems.length > 0 ? (
              ...
              <div id="cart-empty-state" className="text-center p-16 card bg-white shadow-sm border border-dashed border-gray-300 mt-10">
                <div className="flex flex-col items-center gap-4">
                  <FaCartShopping className="text-6xl text-gray-300" />
          ...
          <div className="lg:w-1/3">
            <div id="order-summary-card" className="card bg-white shadow-lg sticky top-28 border border-gray-100">
              <div className="card-body">
                ...
                <div className="card-actions mt-8 flex flex-col gap-3">
                  <button 
                    id="btn-checkout"
                  ...
                  <button 
                    ...
                    className="btn bg-white hover:bg-gray-50 text-black w-full border border-gray-300 shadow-md" 
                    onClick={() => navigate("/")}
                  >
                    เลือกซื้อต่อ
                  </button>
