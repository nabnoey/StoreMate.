          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 lg:gap-24 items-center">
            ...
            <div className="flex flex-col justify-center text-center md:text-left">
              ...
              <div className="text-gray-600 text-sm sm:text-base lg:text-lg leading-relaxed space-y-4">
                <p>
                  เราเชื่อว่า{" "}
                  <strong>"สุขภาพที่ดีคือพื้นฐานของชีวิตที่ร่มเย็น"</strong>
                  <br />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            <div className="lg:col-span-5 flex flex-col justify-center space-y-6">
              ...
              <div className="space-y-4 text-sm md:text-base text-gray-300 leading-relaxed font-light">
                <p>
                  ...
                  เรากลับหลงใหลในความเปรี้ยวอมหวานและสรรพคุณของ
                  "มะม่วงหาวมะนาวโห่" สมุนไพรไทยที่ถูกลืม
                  เราจึงหยิบเอาภูมิปัญญาดั้งเดิมมาปัดฝุ่นใหม่
                ...
                <div>
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-gray-400">
                    ...
                    <li>
                      ...
                      เลือกเฉพาะผลที่สุกงอมเพื่อให้ได้สารแอนโทไซยานิน
                      (Anthocyanin) สูงสุด
                    </li>
                    <li>
                      <strong className="text-gray-300">
                      ...
                      ไม่ใส่สารกันบูด ไม่แต่งกลิ่นสังเคราะห์
                      ความสดชื่นที่คุณสัมผัสมาจากธรรมชาติ 100%
                    </li>
                  </ul>
                </div>
                <div className="pt-4">
                  ...
                  <p>
                    ไม่ใช่แค่น้ำผลไม้สมุนไพร แต่คือ Experience
                    ของการดื่มความสดชื่นที่มาพร้อมกับความใส่ใจ
                    ตั้งแต่กระบวนการปลูกแบบออร์แกนิค
            ...
            <div className="lg:col-span-7 w-full relative">
              <div className="relative w-full rounded-xl overflow-hidden shadow-[0_0_50px_rgba(0,0,0,0.8)]">
                <img
                  src={padthongLogo}
                  alt="สมุนไพรมะม่วงหาว มะนาวโห่ ตรา พัดทอง"
            ...
            <div className="w-[90%] max-w-[940px] min-h-[274px] bg-[#1B3022] rounded-l-[30px] py-10 px-4 sm:px-10 md:px-16 shadow-2xl flex items-center">
              <div className="flex flex-col items-start text-left w-full gap-2 md:gap-3">
                ...
                <p className="text-xs sm:text-sm md:text-base text-gray-300 font-bold max-w-2xl self-end text-right pt-4 md:pt-9">
                  จากภูมิปัญญาหลังบ้าน สู่ผลิตภัณฑ์คุณภาพ...
                  ปัดฝุ่นสมุนไพรไทยให้กลับมา
                </p>
              </div>
            </div>
          </div>
