...
const updateProfile = async (data: Partial<Address>) => {
  const res = await api.put(`${import.meta.env.VITE_USERS_API}/me/overview`, data);
  return res.data;
};
...
const fetchAddressUserId = async (id: number) => {
  const res = await api.get(
    `${import.meta.env.VITE_USERS_API}/me/addresses/${id}`,
  );
  return res.data;
};
...
const fetchAllAddresses = async () => {
  const res = await api.get(`${import.meta.env.VITE_USERS_API}/me/addresses`);
  return res.data;
};
...
const addAddress = async (data: Partial<Address>) => {
  const res = await api.post(
    `${import.meta.env.VITE_USERS_API}/me/addresses`,
    data,
  );
  return res.data;
};
...
const fetchDefaultAddress = async () => {
  const res = await api.get(
    `${import.meta.env.VITE_USERS_API}/me/addresses/default`,
  );
  return res.data;
};
