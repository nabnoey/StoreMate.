...
// import type {  OrderMod, OrderItem } from "../../types/moderator/ordersMod";
...
//   const items = order.shippingItems ?? order.orderItems ?? [];
...
//                   <div style={{ fontSize: "12px", fontWeight: "600" }}>{order.senderInfo?.name}</div>
//                   <div style={{ fontSize: "12px" }}>{order.senderInfo?.phone}</div>
...
//                  {items.length > 0 ? (&& (order.shippingItems || order.orderItems)?.length ? (
//                   (order.shippingItems || order.orderItems || []).map(...)
//                 ) => (
//                     <div
